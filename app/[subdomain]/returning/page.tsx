        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <RotateCcw className="w-6 h-6 text-gray-900 mr-2" />
          ...
          <div className="prose prose-lg max-w-none">
            <div
              dangerouslySetInnerHTML={{
                __html: siteData?.returning || (isArabic
                  ? '<h2>سياسة الإرجاع</h2><p>نحن نقدم سياسة إرجاع مرنة لضمان رضا عملائنا. يمكنك إرجاع المنتجات خلال 30 يوماً من تاريخ الاستلام.</p>'
                  : '<h2>Return Policy</h2><p>We offer a flexible return policy to ensure customer satisfaction. You can return products within 30 days of receipt.</p>'
                )
              }}
            />
          </div>
