          ...
          <div className="prose prose-lg max-w-none">
            <div
              dangerouslySetInnerHTML={{
                __html: siteData?.termsOfUse || (isArabic
                  ? '<h2>شروط الاستخدام</h2><p>يرجى قراءة شروط الاستخدام هذه بعناية قبل استخدام موقعنا. باستخدامك لموقعنا، فإنك توافق على الالتزام بهذه الشروط.</p>'
                  : '<h2>Terms of Use</h2><p>Please read these terms of use carefully before using our website. By using our website, you agree to be bound by these terms.</p>'
                )
              }}
            />
          </div>
