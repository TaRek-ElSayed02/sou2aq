        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className={`space-y-8 ${isArabic ? 'text-right' : ''}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-8">
              <button className="flex-1 py-4 bg-gray-900 hover:bg-gray-800 text-white rounded-xl font-bold text-lg transition flex items-center justify-center gap-3 shadow-lg">
