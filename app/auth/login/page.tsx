        ...
        <div className="w-1/2 flex items-center justify-center relative">
          ...
          <div className="w-full bg-white rounded-2xl shadow-lg p-21 flex flex-col justify-center">
            <div>
              ...
              <p className="text-slate-600 mb-8 text-base">Sign in to your account</p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <Link href="/auth/forgetPassword" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                    Forgot Password
                  </Link>
                </div>
      ...
      <div className="block lg:hidden w-full min-h-screen bg-slate-900">
        ...
        <div className="px-2 pb-8">
          <div className="bg-white  rounded-3xl shadow-2xl p-8">
            <h2 className="text-3xl z-100000000 font-bold text-slate-900 mb-2">Welcome Back</h2>
            <p className="text-slate-600 mb-8 text-base">Sign in to your account</p>
            ...
            <div className="space-y-5">
              ...
              <p className="text-center text-sm text-slate-600 pt-2">
                Don't have an account?{' '}
                <Link href="/auth/register" className="text-blue-600 cursor-pointer hover:text-blue-700 font-semibold">
                  Sign up
                </Link>
              </p>
            </div>
